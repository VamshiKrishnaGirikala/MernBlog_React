                ...
                <div className="flex-1">
                    <form className="flex flex-col gap-4" onSubmit={(e) => handleSubmit(e)}>
                        <div>
                            ...
                            <TextInput type="email" placeholder="name@company.com" id="email" onChange={(e) => handleChange(e)} />
                        </div>
                        <div>
                            <Label value="Your password" />
                            <TextInput type="password" placeholder="**********" id="password" onChange={(e) => handleChange(e)} />
                        </div>
